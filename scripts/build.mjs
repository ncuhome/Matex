...
const mainImports = mainRes[0].output[0].imports
const mainDynImports = mainRes[0].output[0].dynamicImports
const mainDeps = [...mainImports,...mainDynImports].filter((item)=>builtinModules.indexOf(item) < 0)
