...
import {ReqUrl, SelReqType} from '/@/store/ApiTest/config.store';
...
const Header = () => {
  const [selReqType, setSelReq] = useAtom(SelReqType);
  ...
  return (
    <div className={styles.header}>
      <MyDropDown menus={ReqMethods}  width={98} selectedKey={selReqType} onSelectionChange={changeSelReq} />
